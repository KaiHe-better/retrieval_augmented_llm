...
def get_loader_USMLE(args, triever_tokenizer, train_file_path, dev_file_path, test_file_path) :
    
    train_dataset = USMLE(args, train_file_path, triever_tokenizer)
    ...
    # for demonstration
    dev_dataset = USMLE(args, dev_file_path, triever_tokenizer)
    ...
    test_dataset = USMLE(args, test_file_path, triever_tokenizer)
