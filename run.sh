...
nohup python run.py --ID model   --gpu 5 --config llama2-7b_USMLE_RA.yaml --train_batch_size 4 --train_retri_num 7 --infer_retri_num 7 --lr 1e-3 >/dev/null 2>&1 &
nohup python run.py --ID model_2 --gpu 6 --config llama2-7b_USMLE_RA.yaml --train_batch_size 4 --train_retri_num 7 --infer_retri_num 7 --lr 1e-3 >/dev/null 2>&1 &
