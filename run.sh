...
nohup python run.py --ID 1   --gpu 1 --config llama2-7b_USMLE_RA.yaml   --loss_list mse+kl >/dev/null 2>&1 &
nohup python run.py --ID 2   --gpu 2 --config llama2-7b_USMLE_RA.yaml   --loss_list mse    >/dev/null 2>&1 &

nohup python run.py --ID 3   --gpu 3 --config llama2-7b_USMLE_RA.yaml   --loss_list kl_soft   >/dev/null 2>&1 &
