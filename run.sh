...
nohup python run.py --ID 0 --gpu 5 --config llama2-7b_USMLE_RA.yaml  --train_batch_size 4 --lr 1e-5 >/dev/null 2>&1 &
nohup python run.py --ID 1 --gpu 6 --config llama2-7b_USMLE_RA.yaml  --train_batch_size 4 --lr 1e-6 >/dev/null 2>&1 &
nohup python run.py --ID 2 --gpu 7 --config llama2-7b_USMLE_RA.yaml  --train_batch_size 4 --lr 5e-6 >/dev/null 2>&1 &
