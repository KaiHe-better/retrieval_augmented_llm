...
# retrieval
parser.add_argument('--infer_retri_num', type=int, default=7, help='max_document_num')
...
parser.add_argument('--train_batch_size', type=int, default=3, help='train_batch_size')
parser.add_argument('--accumulation_steps', type=int, default=1, help='accumulation_steps')
parser.add_argument('--test_batch_size', type=int, default=3, help='test_batch_size')
...
parser.add_argument('--lr', type=float, default=1e-3, help='lr for retriever')
parser.add_argument('--train_eval', type=int, default=99900, help='lr for retriever')
parser.add_argument('--epoch', type=int, default=99999, help='lr for retriever')
parser.add_argument('--confirm_enhanced_acc', type=bool, default=False, help='confirm_enhanced_acc')
